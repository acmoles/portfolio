...
export class ObjectPool {
  ...
  constructor(app, layers) {
    ...
    if (window.innerWidth > 1500) {
      ...
      this.objectsPerLayer = 2;
      this.objectsPerLargeLayer = 1;
    } else {
  ...
  makeObject(scale, layer, i, intro, large) {
    ...
    // let y = ( this.app.screen.height * anime.random(1 - (i * 0.5), i = i > 2 ? 2 : i + 1) ) - ( this.app.screen.height / 1.2 );
    let y = this.app.screen.height * anime.random(1 - (i * 0.5), i) + (this.app.screen.height / 2.5);
