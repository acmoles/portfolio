    ...
    <template slot="content">
      ...
      <div class="page-glass-section">
        ...
        <div class="content">
          ...
          <ul>
            <li>
              “It could act as a digital post-it”
            </li>
            <li>
              “You could remotely send reminders to the location where you will be when you need to remember them”
            </li>
            <li>
              “This would be useful for displaying up-to-date information at public events”
            </li>
            <li>
              “Some kind of two-way communication screen, like those used in remote working and multi-site offices”
            </li>
            <li>
              “It could be a public output screen for a Slack Channel or Whatsapp Group”
            </li>
            <li>
              “E-ink would be the perfect technology to display text-only messages - it could be an Internet of Things hardware product”
            </li>
          </ul>
          ...
          <dl>
            ...
            <dd>+ No dependency on third-party APIs</dd>
            <dd>+ One interface for both authoring messages and displaying them</dd>
            <dd>+ Personal interest in building a mobile app and backend from scratch</dd>
            <dd>- Higher friction in getting testers to adopt a new app</dd>
            <dd>- Approval for various app stores is time consuming</dd>
          </dl>
          ...
          <dl>
            ...
            <dd>+ A familiar app would make adoption easier</dd>
            <dd>+ Slack have an open API which would be suitable</dd>
            <dd>- Most of the people I intended to test with are not Slack mobile users (or users of any other messaging platform for which plugins can be built)</dd>
            <dd>- Two interfaces required - the messaging app plugin and the output screen</dd>
          </dl>
      ...
      <div class="page-glass-section">
        ...
        <div class="content">
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                <td>“I would like to scroll through previous messages”</td>
              ...
              <tr>
                <td>“I’ve made a mistake, is it possible to delete message?”</td>
                <td>I added the ability to delete the previous message</td>
              </tr>
              <tr>
                <td>“I’d like to set the name that appears under my message, rather than just my email”</td>
              ...
              <tr>
                <td>“Could you add a bit of colour?”</td>
              ...
              <tr>
                <td>“Is it possible to search for a specific channel?”</td>
                <td>A good feature idea but not required to test the MVP</td>
              </tr>
              <tr>
                <td>“It would be great if our existing Whatsapp group could show up on the screen - I just don’t have space in my life for another messaging app”</td>
              ...
              <tr>
                <td>“I’d like to be able to favourite a channel and receive notifications when a new message is written in it”</td>
      ...
      <div class="page-glass-section">
        ...
        <div class="content">
          ...
          <p>From the outset of the MVP build I faced two key technology decisions:</p>
          ...
          <dl>
            ...
            <dd>+ Increasingly popular and well supported</dd>
            <dd>+ Native-like performance but written in React and JS</dd>
            <dd>- At that time, not a ‘mature’ platform with constantly changing tooling</dd>
            <dd>- Significant up-front time investment to get started</dd>
          </dl>
          ...
          <dl>
            ...
            <dd>+ Native-like performance</dd>
            <dd>- A good C# learning opportunity but a trade-off with speed</dd>
          </dl>

          <dl>
            <dt>
              <strong>Webview (Cordova)</strong>
            </dt>
            <dd>+ Leverages my existing experience with web technologies</dd>
            <dd>+ Easy to get started</dd>
            <dd>- Relatively poor performance</dd>
          </dl>

          <p>
            I received a strong recommendation from a colleague at toucanBox for the Ionic Framework, which uses webview. Ionic would further speed up this route by offering an established build system and customisable interface widgets.
          </p>
